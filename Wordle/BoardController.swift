...
class BoardController: NSObject,
  ...
  private func applyNumLettersSettings(with settings: [String: Any]) {
    // START YOUR CODE HERE
      if let numItems = settings[kNumLettersKey] as? Int {
          ...
          print("Error: Unable to retrieve the number of items per row from settings.")
      }
    // END YOUR CODE HERE
  }
  ...
  private func applyNumGuessesSettings(with settings: [String: Any]) {
    // START YOUR CODE HERE
      if let numGuess = settings[kNumGuessesKey] as? Int {
          ...
          print("Error: Unable to retrieve the number of rows from settings.")
      }
    // END YOUR CODE HERE
  }
  ...
  private func applyThemeSettings(with settings: [String: Any]) {
    // START YOUR CODE HERE
      print("Before applying theme settings: \(goalWord)")
      if let themeString = settings[kWordThemeKey] as? String {
          if let theme = WordTheme(rawValue: themeString) {
              ...
              print("After applying theme settings: \(goalWord)")
          } else {
              print("Error: Unable to retrieve the theme from settings.")
          }
      }
    // END YOUR CODE HERE
  }
  ...
  private func applyIsAlienWordleSettings(with settings: [String: Any]) {
    // START YOUR CODE HERE
      if let alienWord = settings[kIsAlienWordleKey] as? Bool {
          ...
          print("Error: Unable to retrieve the alien word from settings.")
      }
    // START YOUR CODE HERE
  }
}
